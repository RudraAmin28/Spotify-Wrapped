...
public final class DeleteAccountPopupBinding implements ViewBinding {
  ...
  private DeleteAccountPopupBinding(@NonNull LinearLayout rootView, @NonNull Button buttonDelete) {
  ...
  public static DeleteAccountPopupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DeleteAccountPopupBinding((LinearLayout) rootView, buttonDelete);
    }
